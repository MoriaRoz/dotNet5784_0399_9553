...
internal static class DataSource
{
    internal static class Config //class that creates automatic running numbers.
    {
        ...
        internal const int startDependenciesId = 0;//initial value of the running number of Dependencies.
        private static int nextDependencyId = startDependenciesId;//The ID value of the last added Dependencies.
        internal static int NextDependencyId { get => nextDependencyId++; set => nextDependencyId = value; }//Advancing the running number by 1 for the new Dependencies.
    ...
    internal static List<DO.Dependency> dependencies { get; } = new();//List of dependencies.
