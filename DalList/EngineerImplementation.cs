...
public class EngineerImplementation : IEngineer
{
    ...
    {
        return DataSource.Engineers.Find(Engineer => Engineer.Id == id);//Searching for a engineer with id=id and returning the reference to it.
    }

    public List<Engineer> ReadAll()//Return a copy of the engineer list.
    {
        return new List<Engineer>(DataSource.Engineers);//Creating a copy and returning it.
    }
